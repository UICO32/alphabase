...
This project is indexed by GitNexus as **base** (3033 symbols, 7066 relationships, 251 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
